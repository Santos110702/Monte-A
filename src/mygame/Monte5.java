 ...
 * @author normenhansen
 */
public class Monte5 extends SimpleApplication
  ...
  public void simpleInitApp() {
      DirectionalLight sun = new DirectionalLight();
        ...
        Spatial casona;
        casona = assetManager.loadModel("Models/Monte Alban 5/Monte Alban 5.j3o");
    ...
    player.setFallSpeed(1500);
    player.setGravity(19);
    player.setPhysicsLocation(new Vector3f(0, 0, 20));
